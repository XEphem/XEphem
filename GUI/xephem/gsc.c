...
@param ra0;	center RA, rads 
@param dec0;	center Dec, rads 
@param fov;	field of view, rads 
@param fmag;	faintest mag 
@param **spp;	*spp will be a malloced array of ObjF stars in region 
@param nspp;	if spp: initial number of ObjF already in *spp 
@param msg[];	possible return error or status message 
 */
int
